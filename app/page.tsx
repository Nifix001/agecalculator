  ...
  return (
    <main className="bg-lgrey h-screen w-screen flex justify-center items-center">
      ...
      <div className="flex flex-col">
        ...
        <input 
        className={`border-2 rounded-md h-12 w-32 ${errorD ? "border-red-400" : "border-2"}${errorD ? "outline-red-400" : "outline-purple-300"} cursor-pointer font-poppins text-black font-bold text-xl p-2`} 
        placeholder="DD" 
        type="number" 
        value={day} 
      ...
      <div className="flex flex-col">
        ...
        <input 
        className={`border-2 rounded-md h-12 w-32 ${errorM ? "border-red-400" : "border-2"}${errorM ? "outline-red-400" : "outline-purple-300"} cursor-pointer font-poppins text-black font-bold text-xl p-2`} 
        type="number" 
        placeholder="MM"
        value={month} 
      ...
      <div className="flex flex-col">
        ...
        <input 
       className={`border-2 rounded-md h-12 w-32 ${errorY ? "border-red-400" : "border-2"}${errorY ? "outline-red-400" : "outline-purple-300"} cursor-pointer font-poppins text-black font-bold text-xl p-2`}  
        type="number" 
        placeholder="YYYY"
        value={year} 
